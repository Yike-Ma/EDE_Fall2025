...
*   Navigate to https://www.nconemap.gov/ - NC's home for spatial data
  ...
  -   Note the "Manufactured Gas Plant Site" layer, listed as a *Feature Service* (feature service is spatial dataset)
...
data_source <- paste0(
  ...
  'query?outFields=*&where=1%3D1&f=geojson') #paste0: no spaces between the substrings
...
data_source <- paste0('https://services.arcgis.com/',
'QVENGdaPbd4LUkLV/arcgis/rest/services/',
'survey123_3d7e213f47a94f1b829aa7cf54eab095_results',
...
turtle_map <- leaflet(sea_turtles) %>% 
  addTiles() %>% 
  addMarkers(
    clusterOptions = markerClusterOptions(), #clean your map by making clusters
    popup = ~species
  )
