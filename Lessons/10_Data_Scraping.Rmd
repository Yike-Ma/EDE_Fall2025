...
the_registrant <- webpage %>% 
  ...
  html_text()#.table tr:nth-child(1) .left:nth-child(2)
the_registrant
```
...
avg_withdrawals <- webpage %>% 
  ...
  html_text()#.table:nth-child(7) td:nth-child(7) , .table:nth-child(7) td:nth-child(3)
avg_withdrawals
...
df_withdrawals <- df_withdrawals %>% 
  mutate(Registrant = !!the_registrant,  #!!means setting a variable
...
#Create our scraping function, two inputs for the function
...
the_facility_ids <- the_main_website %>% 
  ...
  html_attr("href") %>% #we don't need the text of this certain tab, but it's attribute          #Pull the "href" attribute from the node
