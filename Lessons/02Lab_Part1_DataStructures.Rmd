...
```{r Creating vectors}
# Vectors ----
vector1 <- c(1,2,5.3,6,-2,4) # Vector type: Numeric, c stands for collectors
vector1
class(vector1)
...
```{r Creating Matrices}
# Matrices ----
matrix1 <- matrix(1:20, nrow = 5,ncol = 4) # [rows, columns]
matrix1
...
matrix3 <- matrix(
  ...
  dimnames = list( #create dimension names
...
matrix1[4,  ] # the whole column because not specified

matrix1[ , 3] #

matrix1[c(12, 14)] # output is only two numbers
...
names(dataframe1) <- c("ID","Color","Passed"); View(dataframe1) # column names
