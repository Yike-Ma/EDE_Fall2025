...
-   Chunks have attributes, set within `{  }`\
    For example: `{r plot AQI, echo=FALSE}` options: echo = F -\> show the output only; include = F -\> show nothing
...
examples: {r, fig.height = 3, fig.width = 4, warning = FALSE, fig.cap = "name"}
