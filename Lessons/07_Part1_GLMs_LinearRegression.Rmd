...
PeterPaul.chem.nutrients <- read.csv("./Data/Processed_KEY/NTL-LTER_Lake_Chemistry_Nutrients_PeterPaul_Processed.csv", stringsAsFactors = TRUE)
...
par(mfrow = c(2,2), mar=c(4,4,4,4)) #divide the plot screen into grids
