...
BR_ts_rainfall <- ts(BR_complete$Rainfall,
                   ...
                   frequency=12) 
#decompose
BR_ts_decomp_rainfall <- stl(BR_ts_rainfall,s.window = "periodic")
plot(BR_ts_decomp_rainfall) #it's seasonal data
...
BR_ts_temp <- ts(BR_complete$Temperature_C,
                   ...
                   frequency=12) 
#decompose
BR_ts_decomp_temp <- stl(BR_ts_temp,s.window = "periodic")
plot(BR_ts_decomp_temp) #it's seasonal data
```
...
br_rainfall_components <- as.data.frame(BR_ts_decomp_rainfall$time.series[,1:3])

br_temp_components <- as.data.frame(BR_ts_decomp_temp$time.series[,1:3])
